...
- **ワークオーダーID**: WO-20250709-009
- **タイトル**: Add detail_report_path to workorder schema and template

- **関連ドキュメント**: projects/solar_circuit/collaboration/design_docs/004_workorder.md
...
- [ ] Add `detail_report_path` field to workorder_template.json
- [ ] Update workorder JSON files to include `detail_report_path`
...
- [ ] `workorder_template.json` contains `detail_report_path`
- [ ] Existing WO-*.json include valid `detail_report_path` entries
...
{
  "id": "WO-20250709-009",
  "title": "Add detail_report_path to workorder schema and template",
