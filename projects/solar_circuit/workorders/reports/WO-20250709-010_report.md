...
- **ワークオーダーID**: WO-20250709-010
- **タイトル**: Load summary_content from detail_report_path in report_generator.py

- **関連ドキュメント**: projects/solar_circuit/collaboration/design_docs/005_workorder.md
...
- [ ] Modify `report_generator.py` to read `workorder["detail_report_path"]`
- [ ] Assign its file contents to `workorder["summary_content"]`
...
- [ ] Report generator loads content from the specified detailed report file
- [ ] `summary_content` reflects the full detailed-report markdown
...
{
  "id": "WO-20250709-010",
  "title": "Load summary_content from detail_report_path in report_generator.py",
